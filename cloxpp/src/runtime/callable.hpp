...
class NativeClock : public LoxCallable {
  public:
    ...
    // to make the call, we pass in a reference to the Interpreter and the list of arguments
    // we wish to run
    std::any call(Interpreter& interpreter, std::vector<std::any> arguments) override {
        ...
        // We then cast one last time to a double for compatability with our interpreter
